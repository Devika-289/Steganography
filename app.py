...
def index():
    ...
    file_path = 'static/textfile/new_textfile.txt'  # Specify the file path where you want to save the file
...
def out():
    ...
    # cv2.imwrite("static/images/new_image.png", img_encoded)

    # #decoding
    # im = cv2.imread("static/images/new_image.png")
    # steg = LSBSteg(im)
